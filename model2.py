...
from torchvision import transforms # PyTorch transforms module
...
# Define the data loaders with normalization
...
class Net(nn.Module): 
    ...
    def forward(self, x):
        ...
        return x # Apply softmax activation to the output to get probabilities
...
if __name__ == '__main__': # If this file is being run directly
    for epoch in range(1, 11):
        train(epoch)
        test()
    torch.save(model.state_dict(), 'model2.pt') # Save the model parameters to a file 